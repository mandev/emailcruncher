...
import com.adlitteram.emailcruncher.Status;
...
public class MainFrame extends JFrame implements PropertyChangeListener {
    ...
    private void updateGuiStatus(Status status) {
    ...
    private void initComponents() {
        ...
        skipUrlField.setText(cruncher.getCruncherModel().getUrlFilter());
        skipUrlField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                skipUrlFieldActionPerformed(evt);
            }
        });

        skipPageField.setText(cruncher.getCruncherModel().getPageFilter());

        skipPageLabel.setText(bundle.getString("SkipPage")); // NOI18N

        skipEmailField.setText(cruncher.getCruncherModel().getEmailFilter());
   ...
   private void goButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_goButtonActionPerformed
       try {
           ...
           cruncherModel.setUrlFilter(skipUrlField.getText().trim());
           cruncherModel.setPageFilter(skipPageField.getText().trim());
           cruncherModel.setEmailFilter(skipEmailField.getText().trim());
           cruncherModel.setSearchLimit(limitCombo.getSelectedIndex());
           cruncherModel.setInLinkDepth(Integer.parseInt((String) inDepthCombo.getSelectedItem()));
           cruncherModel.setOutLinkDepth(Integer.parseInt((String) outDepthCombo.getSelectedItem()));
    ...
    private void skipUrlFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_skipUrlFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_skipUrlFieldActionPerformed
