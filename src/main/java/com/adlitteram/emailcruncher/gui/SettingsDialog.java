...
public class SettingsDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        timeoutField.setText(String.valueOf(cruncher.getCruncherModel().getTimeOut()));

        threadsLabel.setText(bundle.getString("Threads")); // NOI18N

        threadsField.setColumns(4);
        threadsField.setText(String.valueOf(cruncher.getCruncherModel().getThreadMax()));
        ...
        useProxyCheck.setSelected(cruncher.getCruncherModel().isUseProxy());
        ...
        proxyHostField.setText(cruncher.getCruncherModel().getProxyHost());
        proxyHostField.setEnabled(useProxyCheck.isSelected());

        proxyPortField.setColumns(8);
        proxyPortField.setText(String.valueOf(cruncher.getCruncherModel().getProxyPort()));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(proxyPortLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 67, Short.MAX_VALUE))
                .addContainerGap())
        );
   ...
   private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
       try {
           ...
           cruncherModel.setThreadMax(threads);
           cruncherModel.setTimeOut(timeout);
           cruncherModel.setUseProxy(useProxy);
           cruncherModel.setProxyHost(host);
           cruncherModel.setProxyPort(port);
